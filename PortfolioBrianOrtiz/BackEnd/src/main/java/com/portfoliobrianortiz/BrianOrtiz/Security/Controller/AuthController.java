...
import com.portfoliobrianortiz.BrianOrtiz.Security.Service.RolService;
import com.portfoliobrianortiz.BrianOrtiz.Security.Service.UsuarioService;
import com.portfoliobrianortiz.BrianOrtiz.Security.jwt.JwtProvider;
...
@RestController
@RequestMapping("/auth")
@CrossOrigin(origins = "https://proyecto-final-argprog.web.app")
public class AuthController {
    ...
    public ResponseEntity<?> nuevo(@Valid @RequestBody NuevoUsuario nuevoUsuario, BindingResult bindingResult){
        ...
        Usuario usuario = new Usuario (nuevoUsuario.getNombre(), nuevoUsuario.getNombreUsuario(), nuevoUsuario.getNombreUsuario(), passwordEncoder.encode(nuevoUsuario.getPassword()));
